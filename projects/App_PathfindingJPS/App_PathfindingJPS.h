...
// Application
//-----------------------------------------------------------------
class App_PathfindingJPS final : public IApp
{
public:
	//Constructor & Destructor
	App_PathfindingJPS() = default;
	virtual ~App_PathfindingJPS();
...
private:
	...
	App_PathfindingJPS(const App_PathfindingJPS&) = delete;
	App_PathfindingJPS& operator=(const App_PathfindingJPS&) = delete;
};
#endif