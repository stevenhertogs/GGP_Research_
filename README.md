...
The following example shows how in a uniform grid, there can be a lot of differents best paths with the same cost and A* has to add update the openList for ever node
